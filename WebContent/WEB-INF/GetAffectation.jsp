...
<%@ page import="pole_info.Personne,java.util.List,main.java.io.github.dramanebamba.pole_info.model.*" %>
...
<body>
	<div class="container">
	<h1>Consulter les affectations - <% out.println(nom_master+ " - " + nom_contenu.getNomMat()); %></h1>
	<p class="lead">Nombre d'étudiant affecté à ce cours : <% out.println(numAffectation); %></p>
		...
		<% for(Personne p : affectedStudents) {%>
				<tr>
					...
					<td class="test-align">
						<a href="./GetAffectation?operation=remove&id=">
