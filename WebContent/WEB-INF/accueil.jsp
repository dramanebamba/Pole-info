...
<body>
	<div class="container">
		...
		<h2>Base de donn&eacute;es</h2>
			...
			<br />
			<a href="./GetRestoreBackupServlet"> Restaurer la derni�re sauvegarde de la base de donn&eacute;es </a><br />
			<br />
		<%} %>
		<br />
		<h2>Master et contenu</h2>
		<a href="./PostMasterServlet"> Cr&eacute;er un Master </a><br />
		<br />
		<a href="./PostContenuServlet"> Cr&eacute;er un contenu de cours </a><br />
		<br />
