		...
		<div class="page-header">
			<h1 style="color: #000;">
				Bienvenue sur votre espace Pole Info <br /> <small style="color: #FFF;">Vous êtes
					sur la page de gestion des affectations</small>
			</h1>
		</div>
		<h2 style="color: #000;">Gestion des affectation</h2>
		<a class="btn btn-success" href="./AffectationMaster"> Affecter un
			&eacute;tudiant aux cours facultatifs</a><br /> <br />
