...
<title>Base de donn&eacute;es</title>
		...
		<div class="page-header">
			<h1 style="color: #000;">
				Bienvenue sur votre espace Pole Info <br /> <small style="color: #FFF;">Vous êtes
					sur la page de gestion de la base de données</small>
			</h1>
		</div>
		<h2 style="color: #000;">Base de donn&eacute;es</h2>
		<a class="btn btn-primary" href="./GetBackupServlet"> Liste des
			sauvegardes de la base de donn&eacute;es </a><br /> <br /> <a
			class="btn btn-success" href="./GetCreateBackupServlet">
