		...
		<div class="page-header">
			<h1 style="color: #000;">
				Bienvenue sur votre espace Pole Info <br /> <small style="color: #FFF;">Vous êtes
					sur la page de gestion des enseignants</small>
			</h1>
		</div>
		<h2 style="color: #000;">Enseignant</h2>
		<a class="btn btn-success" href="./GetCreateEnseignant">
			Cr&eacute;ation d'un enseignant </a><br /> <br />
