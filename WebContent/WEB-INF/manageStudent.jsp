		...
		<div class="page-header">
			<h1 style="color: #000;">
				Bienvenue sur votre espace Pole Info <br /> <small style="color: #FFF;">Vous êtes
					sur la page des gestion des &eacute;tudiants</small>
			</h1>
		</div>
		<h2 style="color: #000;">&Eacute;tudiant</h2>
		<a class="btn btn-success" href="./GetCreateStudentServlet">
			Cr&eacute;ation d'un &Eacute;tudiant</a> <br /> <br /> <a
			class="btn btn-primary" href="./listStudents?id=<%=id_ma%>">
			Visualiser la liste des etudiants </a> <br /> <br />
